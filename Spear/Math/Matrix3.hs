...
instance Addition Matrix3 Matrix3 where
...
instance Subtraction Matrix3 Matrix3 where
    (Matrix3 a00 a01 a02 a03 a04 a05 a06 a07 a08)
        - (Matrix3 b00 b01 b02 b03 b04 b05 b06 b07 b08)
            = Matrix3 (a00 - b00) (a01 - b01) (a02 - b02)
                      (a03 - b03) (a04 - b04) (a05 - b05)
...
instance Product Matrix3 Matrix3 Matrix3 where
...
setRight    (Vector2 x y) matrix = matrix { m00 = x, m01 = y }
setUp       (Vector2 x y) matrix = matrix { m10 = x, m11 = y }
setPosition (Vector2 x y) matrix = matrix { m20 = x, m21 = y}
setForward = setUp
